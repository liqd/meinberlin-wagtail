...
class FeedbackForm(forms.Form):
    answer1 = forms.CharField(label='Was gefällt Ihnen an den Inhalten von mein.berlin.de?', max_length=1000)
    answer2 = forms.CharField(label='Was missfällt Ihnen an den Inhalten von mein.berlin.de?', max_length=1000)
    answer3 = forms.CharField(label='Was gefällt Ihnen an der technischen Umsetzung von mein.berlin.de?', max_length=1000)
    answer4 = forms.CharField(label='Was missfällt Ihnen an der technischen Umsetzung von mein.berlin.de?', max_length=1000)
